<template>
  <div class="androidBgc">
    ...
    <div class="iphoneBanner">
      <img src="../../../assets/images/android_11.jpg" alt />
    </div>
...
export default {
  data() {
    return {
      iphoneTypeList: [
        { id: 1001, url: "./images/android_03.jpg", name: "小米" },
        { id: 1002, url: "./images/android_03.jpg", name: "小米" },
        { id: 1003, url: "./images/android_03.jpg", name: "小米" },
        { id: 1004, url: "./images/android_03.jpg", name: "小米" },
        { id: 1005, url: "./images/android_03.jpg", name: "小米" }
      ],
      moveList: [
        { id: 2001, url: "./images/android_06.jpg", name: "华为" },
        { id: 2002, url: "./images/android_06.jpg", name: "华为" },
        { id: 2003, url: "./images/android_06.jpg", name: "华为" },
        { id: 2004, url: "./images/android_06.jpg", name: "华为" },
        { id: 2005, url: "./images/android_06.jpg", name: "华为" }
      ],
      productList: [
        // {
        //   id: 2021,
        //   url: "./images/android_15.jpg",
        //   title: "小米 MIX3 8G+128G翡翠",
        //   proTime: "骁龙 845",
        //   label: "同类型最低价",
        //   price: {
        //     newPrice: 2099,
    ...
    axios
      ...
      .then(res => {
        if (res.data.code == 1) {
          ...
          this.productList = productList.splice(30, 26);
        }
      });
  }
};
